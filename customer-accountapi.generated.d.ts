...
export type CustomerEmailForDiscountsQueryVariables = CustomerAccountAPI.Exact<{
  [key: string]: never;
}>;

export type CustomerEmailForDiscountsQuery = {
  customer: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CustomerEmailForDiscounts {\n    customer {\n      emailAddress {\n        emailAddress\n      }\n    }\n  }\n': {
    return: CustomerEmailForDiscountsQuery;
    variables: CustomerEmailForDiscountsQueryVariables;
  };
